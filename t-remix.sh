...
echo
echo "             ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
echo "                             s c r i p t  b y  F u r Y                   " |lolcat -t
echo "             ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
...
#from here copying the hacker.mp3 sound to the $HOME of the user
cp hacker.mp3 /$HOME
...
echo 
echo "            ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
echo "                            s c r i p t  b y  F urY                   " |lolcat -t
echo "            ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
...
tput clear
tput cup 3 30
echo -e "\e[44m Like \e[41m FurY😇 \e[m"
tput cup 6 30
echo -e "\x1b[42m FURY THE CODER\x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m DO YOU LIKE THIS SCRIPT (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou  \e[m"
else
tput cup 17 23
    echo -e "\e[41m 😇😇😇😇😇 \e[m"
fi
tput cup 20 0
figlet -f slant "FurY the coder" |lolcat
